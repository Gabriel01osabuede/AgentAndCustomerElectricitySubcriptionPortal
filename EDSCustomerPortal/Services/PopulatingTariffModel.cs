    ...
    public class PopulateTariffModel
    {
        public static void PopulatingTariffModel()
        {
            ...
            switch (tariffSelection)
            {
                ...
                tarriffModel.PricePerUnit = tariffName.S1;
                break;
                case 2:
                tarriffModel.Name = "A3";
                tarriffModel.PricePerUnit = tariffName.A3;
                break;
                case 3:
                tarriffModel.Name = "D1";
                tarriffModel.PricePerUnit = tariffName.D1;
                break;
                case 4:
                tarriffModel.Name = "R3";
                tarriffModel.PricePerUnit = tariffName.R3;
                break;
                default:
